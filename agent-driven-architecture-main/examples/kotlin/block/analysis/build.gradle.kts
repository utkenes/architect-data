...
// transitively.
//
// ADR-001 §9's Stage 3 HAS LANDED: `src/main/kotlin/adr/blocks/analysis/` holds
...
// transport lives in `:spine` under `adr/blocks/analysis/` and normalises back under
// `blocks/analysis/` for the gate (see spine/build.gradle.kts). The module was DECLARED
