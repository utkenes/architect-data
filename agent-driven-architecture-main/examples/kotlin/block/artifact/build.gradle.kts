...
// transitively.
//
// ADR-001 §9's Stage 3 HAS LANDED: `src/main/kotlin/adr/blocks/artifact/` holds
...
// transport lives in `:spine` under `adr/blocks/artifact/` and normalises back under
// `blocks/artifact/` for the gate (see spine/build.gradle.kts). The module was DECLARED
