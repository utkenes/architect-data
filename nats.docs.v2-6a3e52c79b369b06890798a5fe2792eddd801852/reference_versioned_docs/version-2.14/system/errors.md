...
| Connection rejected since minimum version required is | `ErrLeafNodeMinVersionRejected` | The leafnode protocol error prefix used when rejecting a remote due to leafnodes.min_version. |
