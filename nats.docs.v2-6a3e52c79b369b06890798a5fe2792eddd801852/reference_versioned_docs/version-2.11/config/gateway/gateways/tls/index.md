...
<Reloadable state="reloadable" note="Reloadable for cert_file/key_file/ca_file/cipher_suites/curve_preferences; timeout hard-fails; everything else is discarded." />
