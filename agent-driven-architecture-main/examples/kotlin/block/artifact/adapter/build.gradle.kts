...
//
// ADR-001 §9's Stage 3 HAS LANDED: `src/main/kotlin/adr/blocks/artifact/Adapter.kt`
...
// adapter comes back as `blocks/artifact/Adapter.kt` — the same path the single-module
