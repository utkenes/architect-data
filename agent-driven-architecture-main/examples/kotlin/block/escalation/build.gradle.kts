...
// transitively.
//
// ADR-001 §9's Stage 3 HAS LANDED: `src/main/kotlin/adr/blocks/escalation/` holds
...
// transport lives in `:spine` under `adr/blocks/escalation/` and normalises back under
// `blocks/escalation/` for the gate (see spine/build.gradle.kts). The module was DECLARED
