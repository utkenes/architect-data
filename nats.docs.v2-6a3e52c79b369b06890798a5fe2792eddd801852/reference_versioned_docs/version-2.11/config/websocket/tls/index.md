...
<Reloadable state="reloadable" note="Certificate material reloads. Changing `verify_and_map` or `pinned_certs` fails the reload." />
...
| [`timeout`](./timeout.md) | TLS handshake timeout. | `duration` | `500ms` | Ignored\* |
