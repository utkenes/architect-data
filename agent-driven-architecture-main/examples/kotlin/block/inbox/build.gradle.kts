...
// transitively.
//
// ADR-001 §9's Stage 3 HAS LANDED: `src/main/kotlin/adr/blocks/inbox/` holds
...
// transport lives in `:spine` under `adr/blocks/inbox/` and normalises back under
// `blocks/inbox/` for the gate (see spine/build.gradle.kts). The module was DECLARED
