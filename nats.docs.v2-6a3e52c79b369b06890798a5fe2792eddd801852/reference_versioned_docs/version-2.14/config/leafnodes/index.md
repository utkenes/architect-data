...
<Reloadable state="reloadable" note="Remotes can be added, removed and re-solicited on reload. Changing the leafnode `host`, `port`, `advertise` or `authorization` fails the reload." />
...
| Name | Description | Type | Default | Reloadable |
| :--- | :---------- | :--- | :------ | :--------- |
| [`remotes`](./remotes/index.md) | List of entries specifiying servers where the leaf node client connection can be made. | `object` | - | Yes |
