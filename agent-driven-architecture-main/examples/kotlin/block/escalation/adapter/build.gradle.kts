...
//
// ADR-001 §9's Stage 3 HAS LANDED: `src/main/kotlin/adr/blocks/escalation/Adapter.kt`
...
// adapter comes back as `blocks/escalation/Adapter.kt` — the same path the single-module
