...
> **語言**: [English](../../../core/adversarial-test.md) | 繁體中文 | [简体中文](../../zh-CN/core/adversarial-test.md)
...
- [UDS `llm-output-validation.ai.yaml`](../../../core/llm-output-validation.md) — LLM 輸出驗證標準
